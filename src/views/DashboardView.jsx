  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <StatCard delay="delay-50" label="Total de Racks" value={racks.length} color="bg-brand-50 dark:bg-brand-900/30"
        ...
        />
        <StatCard delay="delay-150" label="Total de TOPs registrados" value={totalTops} color="bg-violet-50 dark:bg-violet-900/30"
        ...
        />
        <StatCard delay="delay-250" label="TOPs agregados hoy" value={todayCount} color="bg-emerald-50 dark:bg-emerald-900/30"
