      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        {selectedRack && (
          <div className="flex items-center gap-2 flex-wrap">
            <button onClick={handleSeed} disabled={seeding} className="btn-secondary text-xs border-dashed flex items-center gap-1.5">
              {seeding ? <><div className="w-3 h-3 border-2 border-gray-400 border-t-transparent rounded-full animate-spin" />Cargando...</> : '50 de prueba'}
            </button>
            {filtered.length > 0 && (
