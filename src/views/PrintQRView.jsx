  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6 animate-fade-in">
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">{t('printQR', 'title')}</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{t('printQR', 'subtitle')}</p>
      </div>

      <div className="card p-4 mb-6 no-print animate-slide-up delay-50">
        <label className="label">{t('printQR', 'selectRack')}</label>
        <select className="input" value={selectedRack} onChange={e => handleRackChange(e.target.value)}>
          <option value="">{t('printQR', 'selectRackOpt')}</option>
      ...
      {selectedRack && rack ? (
        <>
          <div id="print-area" className="card p-8 flex flex-col items-center text-center mb-6 animate-slide-up delay-100">
            <div className="mb-4">
            ...
            <div className="mt-5">
              ...
              <p className="text-sm text-gray-500 mt-1">{topCount} {t('printQR', 'registered')}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 no-print animate-slide-up delay-150">
        ...
        <div className="card p-12 text-center text-gray-400 dark:text-gray-500 text-sm animate-fade-in delay-100">
          {t('printQR', 'selectToGen')}
        </div>
      )}
    </div>
  )
